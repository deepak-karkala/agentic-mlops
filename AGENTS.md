...
OPENAI_API_KEY=your-openai-api-key              # For LangGraph agent orchestration
ANTHROPIC_API_KEY=your-anthropic-api-key        # For Claude Code generation
...
- **LLM API errors**: Verify `OPENAI_API_KEY` and `ANTHROPIC_API_KEY` are set correctly
