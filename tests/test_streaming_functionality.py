...
class TestStreamingService:
    ...
    async def test_subscription_with_new_events(self):
        ...
        await self.streaming_service.emit_node_start(self.test_decision_set_id, "new_node", "New node started")
        await self.streaming_service.emit_node_complete(self.test_decision_set_id, "new_node", message="New node completed")
    ...
    def test_event_limit_enforcement(self):
        ...
        all_events = self.streaming_service.get_events(self.test_decision_set_id, limit=None)
        events_with_default_limit = self.streaming_service.get_events(self.test_decision_set_id)
    ...
    def test_cleanup_events(self):
        ...
        # Add some events
        asyncio.run(self.streaming_service.emit_node_start(self.test_decision_set_id, "test_node"))
    ...
    async def test_connection_count_tracking(self):
        ...
        initial_count = await self.streaming_service.get_connection_count(self.test_decision_set_id)
        ...
        count = await self.streaming_service.get_connection_count(self.test_decision_set_id)
        ...
        final_count = await self.streaming_service.get_connection_count(self.test_decision_set_id)
...
class TestStreamWriter:
    ...
    def test_emit_node_events(self):
        ...
        self.stream_writer.emit_node_complete("test_node", {"result": "success"}, "Completed test")
...
class TestStreamingIntegration:
    ...
    async def test_streaming_service_integration(self):
        ...
        await streaming_service.emit_node_start(decision_set_1, "planner", "Planning started")
        await streaming_service.emit_node_start(decision_set_2, "critic_tech", "Tech analysis started")
