...
describe('ChatInterface', () => {
  ...
  it('renders welcome message when no messages exist', () => {
    ...
    expect(screen.getByText('Start a conversation to design your MLOps infrastructure')).toBeInTheDocument();
  });

  it('renders input field and send button', () => {
    render(<ChatInterface />);
    
    expect(screen.getByPlaceholderText('Describe your MLOps requirements...')).toBeInTheDocument();
  ...
  it('updates input value when typing', async () => {
    ...
    const input = screen.getByPlaceholderText('Describe your MLOps requirements...');
